...
// In this modified version of the code, I have added functionality to load exercise data from a text file (exerciseData.txt) 
// and authenticate the user to view their exercise data. 
